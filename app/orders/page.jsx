      ...
      <div className="w-full space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage your subscription and redemption orders
          </p>
        </div>
                ...
                <TableBody>
                  {redemptionOrders.length === 0 ? (
                    ...
                    redemptionOrders.map((order) => (
                      <TableRow key={order.id}>{/* same structure */}</TableRow>
                    ))
                  )}
                </TableBody>
              </Table>
          ...
          <AlertDialogHeader className="text-center space-y-4">
            ...
            <AlertDialogDescription className="text-base text-center">
              ...
              <code className="block mt-3 text-xs bg-muted px-3 py-2 rounded font-mono">
                {orderToCancel?.paymentReference ||
                  "f56-42a-da32-dcf12-af123-12123"}
              </code>
            </AlertDialogDescription>
          </AlertDialogHeader>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    onClick={() =>
                      copyToClipboard(selectedOrder.investorWallet)
                    }
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedOrder.docuSignEnvelope || "-"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">TxHash</span>
                    <p className="font-medium">{selectedOrder.txHash || "-"}</p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                      Number of tokens at order creation
                    </span>
                    <p className="font-medium">
                      {selectedOrder.tokensAtCreation ||
                        selectedOrder.tokensOrdered}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                    ...
                    <p className="font-medium">
                      {selectedOrder.exchangeRateAtCreation || "-"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                      Net investment at order creation
                    </span>
                    <p className="font-medium">
                      {selectedOrder.netInvestmentAtCreation || "-"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                      Fee at order creation
                    </span>
                    <p className="font-medium">
                      {selectedOrder.feeAtCreation || "USDC 0"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">Amount to pay</span>
                    <p className="font-medium">{selectedOrder.amountToPay}</p>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div>
                    <span className="text-muted-foreground">
                      Number of tokens at confirmation
                    </span>
                    <p className="font-medium">
                      {selectedOrder.tokensAtConfirmation ||
                        selectedOrder.tokensOrdered}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                      Exchange rate at confirmation
                    </span>
                    <p className="font-medium">
                      {selectedOrder.exchangeRateAtConfirmation || "-"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                      Net investment at confirmation
                    </span>
                    <p className="font-medium">
                      {selectedOrder.netInvestmentAtConfirmation || "-"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                    ...
                    <p className="font-medium">
                      {selectedOrder.feeAtConfirmation || "USDC 0"}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">
                    ...
                    <p className="font-medium">
                      {selectedOrder.confirmedPayment || "-"}
                    </p>
                  </div>
                </div>
              </div>
